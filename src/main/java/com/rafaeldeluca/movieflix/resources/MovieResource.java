...
public class MovieResource {
	...
	/*
	 * @GetMapping public ResponseEntity<Page<MovieDTO>> findAll (
	 * 
	 ...
	 * 
	 * PageRequest pagerequest = PageRequest.of(page, linerPerPage,
	 * Direction.valueOf(direction), orderBy); Page<MovieDTO> paginatedList =
	 * service.findAllPaged(pagerequest); return
	 * ResponseEntity.ok().body(paginatedList);
	 * 
	 * }
	 */
	...
	@GetMapping
	public ResponseEntity<Page<MovieSimpleDTO>> findMovieByGenre(
			@RequestParam(value = "genreId", defaultValue = "0") Long genreId,
			Pageable pageable) {
		Page<MovieSimpleDTO> listaPaginada = service.buscaTodasPaginas(genreId, pageable);
